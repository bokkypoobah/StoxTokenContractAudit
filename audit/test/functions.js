...
addAccount("0x0010230123012010312300102301230120103121", "Account #11 - Partner 1 / Invest.com 12.5%");
addAccount("0x0010230123012010312300102301230120103122", "Account #12 - Partner 2 / Stox 10%");
addAccount("0x0010230123012010312300102301230120103123", "Account #13 - Partner 3");
addAccount("0x0010230123012010312300102301230120103124", "Account #14 - Partner 4");
addAccount("0x0010230123012010312300102301230120103125", "Account #15 - Partner 5");
addAccount("0x0010230123012010312300102301230120103129", "Account #15 - Partner 6 - Strategic Partnership");
...
function printCrowdsaleContractDetails() {
  ...
  if (crowdsaleContractAddress != null && crowdsaleContractAbi != null) {
    ...
    console.log("RESULT: crowdsale.ETH_PRICE_USD=" + contract.ETH_PRICE_USD());
    console.log("RESULT: crowdsale.EXCHANGE_RATE=" + contract.EXCHANGE_RATE());
    console.log("RESULT: crowdsale.PARTNER_TOKENS=" + contract.PARTNER_TOKENS().shift(-18));
